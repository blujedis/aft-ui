...
const bgItemCurrent = {
  ...
  dark: 'aria-current:bg-frame-500 dark:aria-current:bg-frame-800',
...
const bgItemExpanded = {
  ...
  dark: 'aria-expanded:bg-frame-500 dark:aria-expanded:bg-frame-800',
...
const bgItemChecked = {
  ...
  dark: 'aria-checked:bg-frame-500 dark:aria-checked:bg-frame-800',
