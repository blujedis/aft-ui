const baseVariant = {
	$base:
		'text-default-600 hover:bg-default-100 aria-selected:bg-default-100 aria-current:bg-default-100',
	white: 'hover:text-default-200 aria-selected:text-white aria-current:text-white',
	default: 'hover:text-default-900 aria-selected:bg-default-100 aria-current:bg-default-100',
