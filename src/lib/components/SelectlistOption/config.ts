const baseVariant = {
	$base:
		'text-frame-600 hover:bg-frame-100 aria-selected:bg-frame-100 aria-current:bg-frame-100',
	white: 'hover:text-frame-200 aria-selected:text-white aria-current:text-white',
	frame: 'hover:text-frame-900 aria-selected:text-frame-900 aria-current:text-frame-900',
