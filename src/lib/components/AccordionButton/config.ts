...
export const accordionButton = {
	...
	filled: mergeConfigs(textAriaExpanded, bgAriaExpanded, {
		$base:
			'bg-frame-100 dark:bg-frame-500/30 aria-expanded:bg-frame-200 mb-1 aria-expanded:text-white dark:aria-expanded:text-white aria-expanded:font-medium',
		light: 'dark:aria-expanded:text-[color:var(--text-light)]',
	...
	glass: mergeConfigs(textAriaExpanded, bgAriaGlassExpanded, {
		$base: 'bg-frame-100 dark:bg-frame-500/10 mb-1 dark:aria-expanded:text-white aria-expanded:font-medium',
		light: 'dark:aria-expanded:text-[color:var(--text-light)]',
		dark: 'dark:aria-expanded:text-[color:var(--text-light)]'
	})
};
