...
const primary = {
	...
	bg_active: 'focus:bg-primary dark:focus:bg-primary-600',
	bg_active_selected: 'bg-primary dark:bg-primary-600',
...
const secondary = {
	...
	bg_active: 'focus:bg-secondary dark:focus:bg-secondary',
...
const tertiary = {
	...
	bg_active: 'focus:bg-tertiary dark:focus:bg-tertiary',
...
const quaternary = {
	...
	bg_active: 'focus:bg-quaternary dark:focus:bg-quaternary',
...
const danger = {
	...
	bg_active: 'focus:bg-danger dark:focus:bg-danger',
...
const warning = {
	...
	bg_active: 'focus:bg-warning dark:focus:bg-warning',
...
const success = {
	...
	bg_active: 'focus:bg-success dark:focus:bg-success',
...
const info = {
	...
	bg_active: 'focus:bg-info dark:focus:bg-info',
