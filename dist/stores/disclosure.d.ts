...
> &
	DisclosureMethods<P>;
export declare function useDisclosure<P extends Record<string, unknown> = Record<string, unknown>>(
	props?: DisclosureProps<P>
): {
	open: () => void;
	close: () => void;
	toggle: () => void;
	...
	subscribe(
		this: void,
		run: import('svelte/store').Subscriber<Required<DisclosureProps<P>>>,
		invalidate?: import('svelte/store').Invalidator<Required<DisclosureProps<P>>> | undefined
