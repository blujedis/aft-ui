...
declare const __propDef: {
	props: {
		alt: string;
		notification?: boolean | 'top-right' | 'bottom-right' | 'top-left' | 'bottom-left' | undefined;
		...
		'on:copy'?:
			| import('svelte/elements').ClipboardEventHandler<HTMLImageElement>
			| null
			| undefined;
		...
		'on:paste'?:
			...
			| undefined;
		'on:compositionend'?:
			| import('svelte/elements').CompositionEventHandler<HTMLImageElement>
			| null
			| undefined;
		'on:compositionstart'?:
			| import('svelte/elements').CompositionEventHandler<HTMLImageElement>
		...
		'on:focusout'?:
			| import('svelte/elements').FocusEventHandler<HTMLImageElement>
			| null
			| undefined;
		...
		'on:beforeinput'?:
			| import('svelte/elements').EventHandler<InputEvent, HTMLImageElement>
			| null
			| undefined;
		...
		'on:submit'?:
			| import('svelte/elements').EventHandler<SubmitEvent, HTMLImageElement>
			| null
			| undefined;
		'on:invalid'?:
			| import('svelte/elements').EventHandler<Event, HTMLImageElement>
			| null
			| undefined;
		'on:formdata'?:
			| import('svelte/elements').EventHandler<FormDataEvent, HTMLImageElement>
			| null
			| undefined;
		...
		'on:toggle'?:
			...
			| undefined;
		'on:keydown'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLImageElement>
			| null
			| undefined;
		'on:keypress'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLImageElement>
		...
		'on:waiting'?:
			...
			| undefined;
		'on:auxclick'?:
			| import('svelte/elements').MouseEventHandler<HTMLImageElement>
			| null
			| undefined;
		...
		'on:dragenter'?:
			| import('svelte/elements').DragEventHandler<HTMLImageElement>
			| null
			| undefined;
		...
		'on:selectstart'?:
			...
			| undefined;
		'on:touchcancel'?:
			| import('svelte/elements').TouchEventHandler<HTMLImageElement>
			| null
			| undefined;
		'on:touchend'?:
			| import('svelte/elements').TouchEventHandler<HTMLImageElement>
		...
		'on:gotpointercapture'?:
			| import('svelte/elements').PointerEventHandler<HTMLImageElement>
			| null
			| undefined;
		'on:pointercancel'?:
			| import('svelte/elements').PointerEventHandler<HTMLImageElement>
		...
		'on:animationstart'?:
			| import('svelte/elements').AnimationEventHandler<HTMLImageElement>
			| null
			| undefined;
		'on:animationend'?:
			| import('svelte/elements').AnimationEventHandler<HTMLImageElement>
		...
		'on:animationiteration'?:
			...
			| undefined;
		'on:transitionstart'?:
			| import('svelte/elements').TransitionEventHandler<HTMLImageElement>
			| null
			| undefined;
		'on:transitionrun'?:
			| import('svelte/elements').TransitionEventHandler<HTMLImageElement>
		...
		'on:transitioncancel'?:
			...
			| undefined;
		'on:outrostart'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLImageElement>
			| null
			| undefined;
		'on:outroend'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLImageElement>
		...
		'on:introend'?:
			...
			| undefined;
		'on:message'?:
			| import('svelte/elements').MessageEventHandler<HTMLImageElement>
			| null
			| undefined;
		'on:messageerror'?:
			| import('svelte/elements').MessageEventHandler<HTMLImageElement>
