...
$:
  wrapperClasses = th.create("ModalWrapper").variant("modal", variant, theme, true).append("fixed inset-0 z-10 overflow-y-auto", true).append($$restProps.class, true).compile(true);
$:
