...
declare const __propDef: {
	props: {
		...
		'on:copy'?:
			| import('svelte/elements').ClipboardEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:cut'?:
			| import('svelte/elements').ClipboardEventHandler<HTMLOptionElement>
		...
		'on:paste'?:
			...
			| undefined;
		'on:compositionend'?:
			| import('svelte/elements').CompositionEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:compositionstart'?:
			| import('svelte/elements').CompositionEventHandler<HTMLOptionElement>
		...
		'on:compositionupdate'?:
			...
			| null
			| undefined;
		'on:focus'?: import('svelte/elements').FocusEventHandler<HTMLOptionElement> | null | undefined;
		'on:focusin'?:
			| import('svelte/elements').FocusEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:focusout'?:
			| import('svelte/elements').FocusEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:blur'?: import('svelte/elements').FocusEventHandler<HTMLOptionElement> | null | undefined;
		'on:change'?: import('svelte/elements').FormEventHandler<HTMLOptionElement> | null | undefined;
		'on:beforeinput'?:
			| import('svelte/elements').EventHandler<InputEvent, HTMLOptionElement>
			| null
			| undefined;
		'on:input'?: import('svelte/elements').FormEventHandler<HTMLOptionElement> | null | undefined;
		'on:reset'?: import('svelte/elements').FormEventHandler<HTMLOptionElement> | null | undefined;
		'on:submit'?:
			| import('svelte/elements').EventHandler<SubmitEvent, HTMLOptionElement>
			| null
			| undefined;
		'on:invalid'?:
			| import('svelte/elements').EventHandler<Event, HTMLOptionElement>
			| null
			| undefined;
		'on:formdata'?:
			| import('svelte/elements').EventHandler<FormDataEvent, HTMLOptionElement>
			| null
			| undefined;
		...
		'on:toggle'?:
			...
			| undefined;
		'on:keydown'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:keypress'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLOptionElement>
		...
		'on:pause'?:
			...
			| null
			| undefined;
		'on:play'?: import('svelte/elements').EventHandler<Event, HTMLOptionElement> | null | undefined;
		'on:playing'?:
			| import('svelte/elements').EventHandler<Event, HTMLOptionElement>
			| null
			| undefined;
		...
		'on:waiting'?:
			...
			| undefined;
		'on:auxclick'?:
			| import('svelte/elements').MouseEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:click'?: import('svelte/elements').MouseEventHandler<HTMLOptionElement> | null | undefined;
		'on:contextmenu'?:
			| import('svelte/elements').MouseEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:dblclick'?:
			...
			| null
			| undefined;
		'on:drag'?: import('svelte/elements').DragEventHandler<HTMLOptionElement> | null | undefined;
		'on:dragend'?: import('svelte/elements').DragEventHandler<HTMLOptionElement> | null | undefined;
		'on:dragenter'?:
			| import('svelte/elements').DragEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:dragexit'?:
			| import('svelte/elements').DragEventHandler<HTMLOptionElement>
		...
		'on:dragstart'?:
			...
			| null
			| undefined;
		'on:drop'?: import('svelte/elements').DragEventHandler<HTMLOptionElement> | null | undefined;
		'on:mousedown'?:
			| import('svelte/elements').MouseEventHandler<HTMLOptionElement>
			| null
			| undefined;
		...
		'on:selectstart'?:
			...
			| undefined;
		'on:touchcancel'?:
			| import('svelte/elements').TouchEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:touchend'?:
			| import('svelte/elements').TouchEventHandler<HTMLOptionElement>
		...
		'on:gotpointercapture'?:
			| import('svelte/elements').PointerEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:pointercancel'?:
			| import('svelte/elements').PointerEventHandler<HTMLOptionElement>
		...
		'on:lostpointercapture'?:
			...
			| null
			| undefined;
		'on:scroll'?: import('svelte/elements').UIEventHandler<HTMLOptionElement> | null | undefined;
		'on:resize'?: import('svelte/elements').UIEventHandler<HTMLOptionElement> | null | undefined;
		'on:wheel'?: import('svelte/elements').WheelEventHandler<HTMLOptionElement> | null | undefined;
		'on:animationstart'?:
			| import('svelte/elements').AnimationEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:animationend'?:
			| import('svelte/elements').AnimationEventHandler<HTMLOptionElement>
		...
		'on:animationiteration'?:
			...
			| undefined;
		'on:transitionstart'?:
			| import('svelte/elements').TransitionEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:transitionrun'?:
			| import('svelte/elements').TransitionEventHandler<HTMLOptionElement>
		...
		'on:transitioncancel'?:
			...
			| undefined;
		'on:outrostart'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLOptionElement>
			| null
			| undefined;
		'on:outroend'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLOptionElement>
		...
		'on:introend'?:
			...
			| undefined;
		'on:message'?:
			| import('svelte/elements').MessageEventHandler<HTMLOptionElement>
			| null
			| undefined;
		'on:messageerror'?:
			| import('svelte/elements').MessageEventHandler<HTMLOptionElement>
