...
export default class Component<Tag extends HTMLTag, Store extends DisclosureStore> extends SvelteComponentTyped<ComponentProps<Tag, Store>, ComponentEvents<Tag, Store>, ComponentSlots<Tag, Store>> {
    get store(): Store & {};
}
export {};
