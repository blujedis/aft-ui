<script>import { ColorMode, Switch } from "..";
...
<ColorMode let:checked let:toggle>
	<Switch {checked} on:change={toggle} shadowed="lg" class="fixed bottom-4 right-6 z-50" />
</ColorMode>
...
<div>
	...
	<main class="lg:pl-72">
		<div class="xl:pr-96">
			<div class="px-4 py-10 sm:px-6 lg:px-8 lg:py-6">Main</div>
		</div>
	</main>
