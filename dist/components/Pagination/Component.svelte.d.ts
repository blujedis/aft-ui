...
export default class Component<Item extends Record<string, any>> extends SvelteComponentTyped<ComponentProps<Item>, ComponentEvents<Item>, ComponentSlots<Item>> {
    get context(): {
        globals: Partial<{
            rounded: import("../..").ThemeRounded;
            shadowed: import("../..").ThemeShadowed;
