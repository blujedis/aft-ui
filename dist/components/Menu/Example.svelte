...
const sourceItems = [
  ...
  },
  {
    value: "svelte",
    label: "Svelte",
    description: "Svelte shifts as much work as possible out of the browser and into your build step. No more manual optimisations \u2014 just faster, more efficient apps.",
    active: false,
