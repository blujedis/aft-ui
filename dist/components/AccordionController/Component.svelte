...
$:
  accordionClasses = th.create("Accordion").variant("accordion", variant, theme, true).option("roundeds", rounded === "full" && variant !== "pills" ? "xl2" : rounded, rounded).option("shadows", shadowed, shadowed).append($$restProps.class, true).compile(true);
</script>
