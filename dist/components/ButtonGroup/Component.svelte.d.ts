...
declare const __propDef: {
	props: {
		store?:
			| import('../../stores/select').SelectStore<{
		...
		selected?:
			...
			| import('../../stores/select').SelectValue[]
			| undefined;
		variant?: 'default' | 'link' | 'outlined' | 'filled' | 'ghost' | undefined;
		...
		'on:paste'?:
			| import('svelte/elements').ClipboardEventHandler<HTMLSpanElement>
			| null
			| undefined;
		'on:compositionend'?:
			| import('svelte/elements').CompositionEventHandler<HTMLSpanElement>
			| null
			| undefined;
		'on:compositionstart'?:
			| import('svelte/elements').CompositionEventHandler<HTMLSpanElement>
		...
		'on:beforeinput'?:
			| import('svelte/elements').EventHandler<InputEvent, HTMLSpanElement>
			| null
			| undefined;
		...
		'on:submit'?:
			| import('svelte/elements').EventHandler<SubmitEvent, HTMLSpanElement>
			| null
			| undefined;
		'on:invalid'?:
			| import('svelte/elements').EventHandler<Event, HTMLSpanElement>
			| null
			| undefined;
		'on:formdata'?:
			| import('svelte/elements').EventHandler<FormDataEvent, HTMLSpanElement>
			| null
			| undefined;
		...
		'on:keydown'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLSpanElement>
			| null
			| undefined;
		'on:keypress'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLSpanElement>
		...
		'on:contextmenu'?:
			| import('svelte/elements').MouseEventHandler<HTMLSpanElement>
			| null
			| undefined;
		...
		'on:selectstart'?:
			...
			| undefined;
		'on:touchcancel'?:
			| import('svelte/elements').TouchEventHandler<HTMLSpanElement>
			| null
			| undefined;
		...
		'on:gotpointercapture'?:
			| import('svelte/elements').PointerEventHandler<HTMLSpanElement>
			| null
			| undefined;
		'on:pointercancel'?:
			| import('svelte/elements').PointerEventHandler<HTMLSpanElement>
		...
		'on:animationstart'?:
			| import('svelte/elements').AnimationEventHandler<HTMLSpanElement>
			| null
			| undefined;
		'on:animationend'?:
			| import('svelte/elements').AnimationEventHandler<HTMLSpanElement>
		...
		'on:animationiteration'?:
			...
			| undefined;
		'on:transitionstart'?:
			| import('svelte/elements').TransitionEventHandler<HTMLSpanElement>
			| null
			| undefined;
		'on:transitionrun'?:
			| import('svelte/elements').TransitionEventHandler<HTMLSpanElement>
		...
		'on:transitioncancel'?:
			...
			| undefined;
		'on:outrostart'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLSpanElement>
			| null
			| undefined;
		'on:outroend'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLSpanElement>
		...
		'on:introend'?:
			...
			| undefined;
		'on:message'?:
			| import('svelte/elements').MessageEventHandler<HTMLSpanElement>
			| null
			| undefined;
		'on:messageerror'?:
			| import('svelte/elements').MessageEventHandler<HTMLSpanElement>
...
export default class Component extends SvelteComponentTyped<
	...
	ComponentSlots
> {
	get store(): import('svelte/store').Writable<
		import('../../stores/select').SelectProps & {
			selected: (string | number)[];
			multiple: boolean;
		}
	> &
