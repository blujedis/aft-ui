...
export type ComponentProps<Tag extends 'a' | 'button' | 'span'> = ReturnType<
	__sveltets_Render<Tag>['props']
>;
export type ComponentEvents<Tag extends 'a' | 'button' | 'span'> = ReturnType<
