export const paginationPage = {
	default: {
		$base: 'aria-selected:text-white text-default-400 hover:text-default-500',
		white:
			'hover:bg-default-200 aria-selected:bg-default-200 hover:text-default-200 aria-selected:text-inherit',
		default:
			'hover:bg-default-200 aria-selected:bg-default-200 aria-selected:text-default-500 hover:text-default-500',
	...
	flushed: {
		$base: 'hover:text-inherit border-transparent text-default-400 aria-selected:text-default-500',
		white: 'hover:text-default-200 aria-selected:text-white aria-selected:border-default-200',
		default:
			'aria-selected:border-default-500 aria-selected:text-default-500 hover:text-default-500',
		primary:
