...
declare class __sveltets_Render<Item extends Record<string, any>> {
	props(): {
		...
		'on:compositionend'?:
			| import('svelte/elements').CompositionEventHandler<HTMLElement>
			| null
			| undefined;
		'on:compositionstart'?:
			| import('svelte/elements').CompositionEventHandler<HTMLElement>
		...
		'on:beforeinput'?:
			| import('svelte/elements').EventHandler<InputEvent, HTMLElement>
			| null
			| undefined;
		...
		'on:submit'?:
			| import('svelte/elements').EventHandler<SubmitEvent, HTMLElement>
			| null
			| undefined;
		'on:invalid'?: import('svelte/elements').EventHandler<Event, HTMLElement> | null | undefined;
		'on:formdata'?:
			| import('svelte/elements').EventHandler<FormDataEvent, HTMLElement>
			| null
			| undefined;
		...
		'on:canplaythrough'?:
			| import('svelte/elements').EventHandler<Event, HTMLElement>
			| null
			| undefined;
		...
		'on:gotpointercapture'?:
			| import('svelte/elements').PointerEventHandler<HTMLElement>
			| null
			| undefined;
		'on:pointercancel'?:
			| import('svelte/elements').PointerEventHandler<HTMLElement>
		...
		'on:animationstart'?:
			| import('svelte/elements').AnimationEventHandler<HTMLElement>
			| null
			| undefined;
		'on:animationend'?:
			| import('svelte/elements').AnimationEventHandler<HTMLElement>
		...
		'on:animationiteration'?:
			...
			| undefined;
		'on:transitionstart'?:
			| import('svelte/elements').TransitionEventHandler<HTMLElement>
			| null
			| undefined;
		'on:transitionrun'?:
			| import('svelte/elements').TransitionEventHandler<HTMLElement>
		...
		'on:transitioncancel'?:
			...
			| undefined;
		'on:outrostart'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLElement>
			| null
			| undefined;
		'on:outroend'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLElement>
		...
		'on:messageerror'?:
			| import('svelte/elements').MessageEventHandler<HTMLElement>
			| null
			| undefined;
		'on:visibilitychange'?:
			| import('svelte/elements').EventHandler<Event, HTMLElement>
...
export type ComponentProps<Item extends Record<string, any>> = ReturnType<
	__sveltets_Render<Item>['props']
>;
export type ComponentEvents<Item extends Record<string, any>> = ReturnType<
	__sveltets_Render<Item>['events']
>;
