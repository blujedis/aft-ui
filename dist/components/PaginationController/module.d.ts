...
export type PaginationControllerContext<T extends Record<string, any> = Record<string, any>> = PaginatorStore<T> & {
    globals: {
...
export interface PaginationControllerProps<T extends Record<string, any> = Record<string, any>> extends PaginatorOptions<T> {
    ellipsis?: boolean;
    rounded?: ThemeRounded;
    shadowed?: ThemeShadowed;
    size?: ThemeSize;
