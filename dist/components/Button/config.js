...
export const variantFilled = {
    ...
    default: 'text-inherit bg-default-200 hover:bg-default-300 ring-default-200 hover:ring-default-300',
...
export const variantGhost = mergeConfigs(variantText, {
    $base: 'text-default-700 hover:text-default-900 border border-transparent bg-transparent hover:ring-1',
...
export const variantFlushed = {
    $base: 'text-inherit border border-l-0 border-r-0 border-t-0 focus:border-b-2 focus:outline-none focus:!ring-0 focus-visible:!ring-0',
