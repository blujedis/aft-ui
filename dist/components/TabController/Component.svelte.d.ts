...
import { type TabControllerContext } from './module';
import { type SelectValue } from '../../stores/select';
declare const __propDef: {
	props: {
		context?: TabControllerContext | undefined;
		...
		navContainerClasses?: string | undefined;
		...
		'on:compositionend'?:
			| import('svelte/elements').CompositionEventHandler<HTMLDivElement>
			| null
			| undefined;
		'on:compositionstart'?:
			| import('svelte/elements').CompositionEventHandler<HTMLDivElement>
		...
		'on:beforeinput'?:
			| import('svelte/elements').EventHandler<InputEvent, HTMLDivElement>
			| null
			| undefined;
		...
		'on:submit'?:
			| import('svelte/elements').EventHandler<SubmitEvent, HTMLDivElement>
			| null
			| undefined;
		'on:invalid'?: import('svelte/elements').EventHandler<Event, HTMLDivElement> | null | undefined;
		'on:formdata'?:
			| import('svelte/elements').EventHandler<FormDataEvent, HTMLDivElement>
			| null
			| undefined;
		...
		'on:keydown'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLDivElement>
			| null
			| undefined;
		'on:keypress'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLDivElement>
		...
		'on:canplaythrough'?:
			| import('svelte/elements').EventHandler<Event, HTMLDivElement>
			| null
			| undefined;
		'on:cuechange'?:
			| import('svelte/elements').EventHandler<Event, HTMLDivElement>
		...
		'on:contextmenu'?:
			| import('svelte/elements').MouseEventHandler<HTMLDivElement>
			| null
			| undefined;
		...
		'on:selectstart'?:
			...
			| undefined;
		'on:touchcancel'?:
			| import('svelte/elements').TouchEventHandler<HTMLDivElement>
			| null
			| undefined;
		...
		'on:gotpointercapture'?:
			| import('svelte/elements').PointerEventHandler<HTMLDivElement>
			| null
			| undefined;
		'on:pointercancel'?:
			| import('svelte/elements').PointerEventHandler<HTMLDivElement>
		...
		'on:animationstart'?:
			| import('svelte/elements').AnimationEventHandler<HTMLDivElement>
			| null
			| undefined;
		'on:animationend'?:
			| import('svelte/elements').AnimationEventHandler<HTMLDivElement>
		...
		'on:animationiteration'?:
			...
			| undefined;
		'on:transitionstart'?:
			| import('svelte/elements').TransitionEventHandler<HTMLDivElement>
			| null
			| undefined;
		'on:transitionrun'?:
			| import('svelte/elements').TransitionEventHandler<HTMLDivElement>
		...
		'on:transitioncancel'?:
			...
			| undefined;
		'on:outrostart'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLDivElement>
			| null
			| undefined;
		'on:outroend'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLDivElement>
		...
		'on:messageerror'?:
			| import('svelte/elements').MessageEventHandler<HTMLDivElement>
			| null
			| undefined;
		'on:visibilitychange'?:
			| import('svelte/elements').EventHandler<Event, HTMLDivElement>
	...
	slots: {
		mobile: {};
		tabs: {
			selectedItems: SelectValue[] & (string | number)[];
			reset: (...selected: SelectValue[]) => void;
			select: (value?: SelectValue | undefined) => void;
			unselect: (value?: SelectValue | undefined) => void;
			isSelected: (value?: SelectValue | undefined) => void;
		};
		panels: {
			selectedItems: SelectValue[] & (string | number)[];
			reset: (...selected: SelectValue[]) => void;
	...
	> &
		import('../../stores/select').SelectMethods & {
			globals: {
				...
				transitioned: import('../..').ThemeTransitioned;
