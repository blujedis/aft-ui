...
declare const __propDef: {
	props: {
		...
		'on:copy'?:
			| import('svelte/elements').ClipboardEventHandler<HTMLOListElement>
			| null
			| undefined;
		...
		'on:paste'?:
			...
			| undefined;
		'on:compositionend'?:
			| import('svelte/elements').CompositionEventHandler<HTMLOListElement>
			| null
			| undefined;
		'on:compositionstart'?:
			| import('svelte/elements').CompositionEventHandler<HTMLOListElement>
		...
		'on:focusout'?:
			| import('svelte/elements').FocusEventHandler<HTMLOListElement>
			| null
			| undefined;
		...
		'on:beforeinput'?:
			| import('svelte/elements').EventHandler<InputEvent, HTMLOListElement>
			| null
			| undefined;
		...
		'on:submit'?:
			| import('svelte/elements').EventHandler<SubmitEvent, HTMLOListElement>
			| null
			| undefined;
		'on:invalid'?:
			| import('svelte/elements').EventHandler<Event, HTMLOListElement>
			| null
			| undefined;
		'on:formdata'?:
			| import('svelte/elements').EventHandler<FormDataEvent, HTMLOListElement>
			| null
			| undefined;
		...
		'on:toggle'?:
			...
			| undefined;
		'on:keydown'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLOListElement>
			| null
			| undefined;
		'on:keypress'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLOListElement>
		...
		'on:waiting'?:
			...
			| undefined;
		'on:auxclick'?:
			| import('svelte/elements').MouseEventHandler<HTMLOListElement>
			| null
			| undefined;
		...
		'on:dragenter'?:
			| import('svelte/elements').DragEventHandler<HTMLOListElement>
			| null
			| undefined;
		...
		'on:selectstart'?:
			...
			| undefined;
		'on:touchcancel'?:
			| import('svelte/elements').TouchEventHandler<HTMLOListElement>
			| null
			| undefined;
		'on:touchend'?:
			| import('svelte/elements').TouchEventHandler<HTMLOListElement>
		...
		'on:gotpointercapture'?:
			| import('svelte/elements').PointerEventHandler<HTMLOListElement>
			| null
			| undefined;
		'on:pointercancel'?:
			| import('svelte/elements').PointerEventHandler<HTMLOListElement>
		...
		'on:animationstart'?:
			| import('svelte/elements').AnimationEventHandler<HTMLOListElement>
			| null
			| undefined;
		'on:animationend'?:
			| import('svelte/elements').AnimationEventHandler<HTMLOListElement>
		...
		'on:animationiteration'?:
			...
			| undefined;
		'on:transitionstart'?:
			| import('svelte/elements').TransitionEventHandler<HTMLOListElement>
			| null
			| undefined;
		'on:transitionrun'?:
			| import('svelte/elements').TransitionEventHandler<HTMLOListElement>
		...
		'on:transitioncancel'?:
			...
			| undefined;
		'on:outrostart'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLOListElement>
			| null
			| undefined;
		'on:outroend'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLOListElement>
		...
		'on:introend'?:
			...
			| undefined;
		'on:message'?:
			| import('svelte/elements').MessageEventHandler<HTMLOListElement>
			| null
			| undefined;
		'on:messageerror'?:
			| import('svelte/elements').MessageEventHandler<HTMLOListElement>
