...
declare const __propDef: {
	props: {
		...
		'on:copy'?:
			| import('svelte/elements').ClipboardEventHandler<HTMLButtonElement>
			| null
			| undefined;
		'on:cut'?:
			| import('svelte/elements').ClipboardEventHandler<HTMLButtonElement>
		...
		'on:paste'?:
			...
			| undefined;
		'on:compositionend'?:
			| import('svelte/elements').CompositionEventHandler<HTMLButtonElement>
			| null
			| undefined;
		'on:compositionstart'?:
			| import('svelte/elements').CompositionEventHandler<HTMLButtonElement>
		...
		'on:focusin'?:
			| import('svelte/elements').FocusEventHandler<HTMLButtonElement>
			| null
			| undefined;
		'on:focusout'?:
			| import('svelte/elements').FocusEventHandler<HTMLButtonElement>
		...
		'on:beforeinput'?:
			| import('svelte/elements').EventHandler<InputEvent, HTMLButtonElement>
			| null
			| undefined;
		...
		'on:submit'?:
			| import('svelte/elements').EventHandler<SubmitEvent, HTMLButtonElement>
			| null
			| undefined;
		'on:invalid'?:
			| import('svelte/elements').EventHandler<Event, HTMLButtonElement>
			| null
			| undefined;
		'on:formdata'?:
			| import('svelte/elements').EventHandler<FormDataEvent, HTMLButtonElement>
			| null
			| undefined;
		...
		'on:toggle'?:
			...
			| undefined;
		'on:keydown'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLButtonElement>
			| null
			| undefined;
		'on:keypress'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLButtonElement>
		...
		'on:dragenter'?:
			| import('svelte/elements').DragEventHandler<HTMLButtonElement>
			| null
			| undefined;
		'on:dragexit'?:
			| import('svelte/elements').DragEventHandler<HTMLButtonElement>
		...
		'on:selectstart'?:
			...
			| undefined;
		'on:touchcancel'?:
			| import('svelte/elements').TouchEventHandler<HTMLButtonElement>
			| null
			| undefined;
		'on:touchend'?:
			| import('svelte/elements').TouchEventHandler<HTMLButtonElement>
		...
		'on:gotpointercapture'?:
			| import('svelte/elements').PointerEventHandler<HTMLButtonElement>
			| null
			| undefined;
		'on:pointercancel'?:
			| import('svelte/elements').PointerEventHandler<HTMLButtonElement>
		...
		'on:animationstart'?:
			| import('svelte/elements').AnimationEventHandler<HTMLButtonElement>
			| null
			| undefined;
		'on:animationend'?:
			| import('svelte/elements').AnimationEventHandler<HTMLButtonElement>
		...
		'on:animationiteration'?:
			...
			| undefined;
		'on:transitionstart'?:
			| import('svelte/elements').TransitionEventHandler<HTMLButtonElement>
			| null
			| undefined;
		'on:transitionrun'?:
			| import('svelte/elements').TransitionEventHandler<HTMLButtonElement>
		...
		'on:transitioncancel'?:
			...
			| undefined;
		'on:outrostart'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLButtonElement>
			| null
			| undefined;
		'on:outroend'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLButtonElement>
		...
		'on:introend'?:
			...
			| undefined;
		'on:message'?:
			| import('svelte/elements').MessageEventHandler<HTMLButtonElement>
			| null
			| undefined;
		'on:messageerror'?:
			| import('svelte/elements').MessageEventHandler<HTMLButtonElement>
