...
const baseVariant = {
    $base: 'bg-default-100 [&::-webkit-progress-bar]:bg-default-200/90',
    white: 'bg-white [&::-webkit-progress-bar]:bg-white [&::-webkit-progress-value]:bg-default-400 [&::-moz-progress-bar]:bg-default-400',
