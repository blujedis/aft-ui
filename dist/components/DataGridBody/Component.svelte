...
$:
  gridBodyClasses = th.create("DataGridBody").option("common", "divided", divided).prepend("datagrid-body overflow-y-auto", true).append("divide-y", divided).append($$restProps.class, true).compile();
</script>
