...
declare const __propDef: {
	props: {
		...
		separator?: string | import('@iconify/svelte').IconifyIcon | undefined;
		...
		'on:copy'?:
			| import('svelte/elements').ClipboardEventHandler<HTMLAnchorElement>
			| null
			| undefined;
		'on:cut'?:
			| import('svelte/elements').ClipboardEventHandler<HTMLAnchorElement>
		...
		'on:paste'?:
			...
			| undefined;
		'on:compositionend'?:
			| import('svelte/elements').CompositionEventHandler<HTMLAnchorElement>
			| null
			| undefined;
		'on:compositionstart'?:
			| import('svelte/elements').CompositionEventHandler<HTMLAnchorElement>
		...
		'on:focusin'?:
			| import('svelte/elements').FocusEventHandler<HTMLAnchorElement>
			| null
			| undefined;
		'on:focusout'?:
			| import('svelte/elements').FocusEventHandler<HTMLAnchorElement>
		...
		'on:submit'?:
			| import('svelte/elements').EventHandler<SubmitEvent, HTMLAnchorElement>
			| null
			| undefined;
		'on:invalid'?:
			...
			| undefined;
		'on:formdata'?:
			| import('svelte/elements').EventHandler<FormDataEvent, HTMLAnchorElement>
			| null
			| undefined;
		...
		'on:toggle'?:
			...
			| undefined;
		'on:keydown'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLAnchorElement>
			| null
			| undefined;
		'on:keypress'?:
			| import('svelte/elements').KeyboardEventHandler<HTMLAnchorElement>
		...
		'on:dragenter'?:
			| import('svelte/elements').DragEventHandler<HTMLAnchorElement>
			| null
			| undefined;
		'on:dragexit'?:
			| import('svelte/elements').DragEventHandler<HTMLAnchorElement>
		...
		'on:selectstart'?:
			...
			| undefined;
		'on:touchcancel'?:
			| import('svelte/elements').TouchEventHandler<HTMLAnchorElement>
			| null
			| undefined;
		'on:touchend'?:
			| import('svelte/elements').TouchEventHandler<HTMLAnchorElement>
		...
		'on:gotpointercapture'?:
			| import('svelte/elements').PointerEventHandler<HTMLAnchorElement>
			| null
			| undefined;
		'on:pointercancel'?:
			| import('svelte/elements').PointerEventHandler<HTMLAnchorElement>
		...
		'on:animationstart'?:
			| import('svelte/elements').AnimationEventHandler<HTMLAnchorElement>
			| null
			| undefined;
		'on:animationend'?:
			| import('svelte/elements').AnimationEventHandler<HTMLAnchorElement>
		...
		'on:animationiteration'?:
			...
			| undefined;
		'on:transitionstart'?:
			| import('svelte/elements').TransitionEventHandler<HTMLAnchorElement>
			| null
			| undefined;
		'on:transitionrun'?:
			| import('svelte/elements').TransitionEventHandler<HTMLAnchorElement>
		...
		'on:transitioncancel'?:
			...
			| undefined;
		'on:outrostart'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLAnchorElement>
			| null
			| undefined;
		'on:outroend'?:
			| import('svelte/elements').EventHandler<CustomEvent<null>, HTMLAnchorElement>
		...
		'on:introend'?:
			...
			| undefined;
		'on:message'?:
			| import('svelte/elements').MessageEventHandler<HTMLAnchorElement>
			| null
			| undefined;
		'on:messageerror'?:
			| import('svelte/elements').MessageEventHandler<HTMLAnchorElement>
