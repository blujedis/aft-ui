...
declare const __propDef: {
	props: {
		...
		easing?: import('svelte/transition').EasingFunction | undefined;
		start?: number | undefined;
		opacity?: number | undefined;
		focustrap?: boolean | undefined;
		position?: 'left' | 'right' | undefined;
		rounded?: import('../../theme').ThemeRounded | undefined;
		shadowed?: import('../../theme').ThemeShadowed | undefined;
		theme?: import('../../theme').ThemeColor | undefined;
		...
		class?:
			...
			| (string & import('../types').ClassArgument[])
			| null
			| undefined;
	...
	slots: {
		default: {
			items: Required<import('../Dropdown/module').DropdownItem>[];
		};
	};
};
