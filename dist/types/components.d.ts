...
export type TypeOrKey<Keys extends string | number | symbol> = Keys | (string & {
    value?: any;
});
/**
 ...
 */
export type PickNativeProps<K extends HTMLTag, E extends keyof ElementProps<K> | undefined = undefined> = E extends undefined ? ElementProps<K> : Pick<ElementProps<K>, Exclude<keyof ElementProps<K>, E>>;
/**
 * Gets type reference to native element props.
 */
export type ElementNativeProps<T extends HTMLTag, A extends keyof ElementProps<T> | undefined = undefined> = PickNativeProps<T, A> & ElementOverrideProps;
export type SvelteConstructorProps<T extends typeof SvelteComponent<any>> = ComponentProps<InstanceType<T>>;
