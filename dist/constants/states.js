export const filledBg = {
    ...
    dark: 'bg-frame-600 dark:bg-frame-950',
...
export const filledBgAriaCurrent = {
    ...
    default: 'aria-expanded:text-current aria-current:bg-frame-200 dark:aria-current:bg-frame-600',
    dark: 'aria-current:bg-frame-600 dark:aria-current:bg-frame-950',
...
export const filledBgAriaExpanded = {
    $base: 'bg-gray-100 dark:bg-frame-800 aria-expanded:text-white',
    default: 'aria-expanded:text-current aria-expanded:bg-frame-200 dark:aria-expanded:bg-frame-600',
    dark: 'aria-expanded:bg-frame-600 dark:aria-expanded:bg-frame-950',
...
export const filledBgAriaSelected = {
    $base: 'bg-gray-100 dark:bg-frame-800 aria-expanded:text-white',
    default: 'aria-expanded:text-current aria-selected:bg-frame-200 dark:aria-selected:bg-frame-600',
    dark: 'aria-selected:bg-frame-600 dark:aria-selected:bg-frame-950',
...
export const filledBgDarkAriaCurrent = {
    $base: 'bg-gray-100 dark:bg-frame-800 aria-expanded:text-white',
    default: 'aria-expanded:text-current dark:aria-current:bg-frame-200 dark:dark:aria-current:bg-frame-600',
    dark: 'dark:aria-current:bg-frame-600 dark:dark:aria-current:bg-frame-950',
    primary: 'dark:aria-current:bg-primary-500 dark:dark:aria-current:bg-primary-500',
    secondary: 'dark:aria-current:bg-secondary-500 dark:dark:aria-current:bg-secondary-500',
    tertiary: 'dark:aria-current:bg-tertiary-500 dark:dark:aria-current:bg-tertiary-500',
    danger: 'dark:aria-current:bg-danger-500 dark:dark:aria-current:bg-danger-500',
    warning: 'dark:aria-current:bg-warning-500 dark:dark:aria-current:bg-warning-500',
    success: 'dark:aria-current:bg-success-500 dark:dark:aria-current:bg-success-500',
    info: 'dark:aria-current:bg-info-500 dark:dark:aria-current:bg-info-500'
};
export const filledBgDarkAriaExpanded = {
    $base: 'bg-gray-100 dark:bg-frame-800 aria-expanded:text-white',
    default: 'aria-expanded:text-current dark:aria-expanded:bg-frame-200 dark:dark:aria-expanded:bg-frame-600',
    dark: 'dark:aria-expanded:bg-frame-600 dark:dark:aria-expanded:bg-frame-950',
    primary: 'dark:aria-expanded:bg-primary-500 dark:dark:aria-expanded:bg-primary-500',
    secondary: 'dark:aria-expanded:bg-secondary-500 dark:dark:aria-expanded:bg-secondary-500',
    tertiary: 'dark:aria-expanded:bg-tertiary-500 dark:dark:aria-expanded:bg-tertiary-500',
    danger: 'dark:aria-expanded:bg-danger-500 dark:dark:aria-expanded:bg-danger-500',
    warning: 'dark:aria-expanded:bg-warning-500 dark:dark:aria-expanded:bg-warning-500',
    success: 'dark:aria-expanded:bg-success-500 dark:dark:aria-expanded:bg-success-500',
    info: 'dark:aria-expanded:bg-info-500 dark:dark:aria-expanded:bg-info-500'
};
export const filledBgDarkAriaSelected = {
    $base: 'bg-gray-100 dark:bg-frame-800 aria-expanded:text-white',
    default: 'aria-expanded:text-current dark:aria-selected:bg-frame-200 dark:dark:aria-selected:bg-frame-600',
    dark: 'dark:aria-selected:bg-frame-600 dark:dark:aria-selected:bg-frame-950',
    primary: 'dark:aria-selected:bg-primary-500 dark:dark:aria-selected:bg-primary-500',
    secondary: 'dark:aria-selected:bg-secondary-500 dark:dark:aria-selected:bg-secondary-500',
    tertiary: 'dark:aria-selected:bg-tertiary-500 dark:dark:aria-selected:bg-tertiary-500',
    danger: 'dark:aria-selected:bg-danger-500 dark:dark:aria-selected:bg-danger-500',
    warning: 'dark:aria-selected:bg-warning-500 dark:dark:aria-selected:bg-warning-500',
    success: 'dark:aria-selected:bg-success-500 dark:dark:aria-selected:bg-success-500',
    info: 'dark:aria-selected:bg-info-500 dark:dark:aria-selected:bg-info-500'
};
export const filledBgEven = {
    default: 'even:bg-frame-200 dark:even:bg-frame-600',
    dark: 'even:bg-frame-600 dark:even:bg-frame-950',
...
export const filledBgOdd = {
    ...
    dark: 'odd:bg-frame-600 dark:odd:bg-frame-950',
...
export const filledFill = {
    ...
    dark: 'fill-frame-600 dark:fill-frame-950',
...
export const filledStroke = {
    ...
    dark: 'stroke-frame-600 dark:stroke-frame-950',
...
export const ghostBgHover = {
    ...
    dark: 'hover:bg-frame-600/40 dark:hover:bg-frame-950/80',
...
export const ghostOutlineFocus = {
    ...
    dark: 'focus:outline-frame-600/40 dark:focus:outline-frame-950/80',
...
export const ghostOutlineFocusVisible = {
    ...
    dark: 'focus-visible:outline-frame-600/40 dark:focus-visible:outline-frame-950/80',
...
export const ghostOutlineFocusWithin = {
    ...
    dark: 'focus-within:outline-frame-600/40 dark:focus-within:outline-frame-950/80',
...
export const ghostOutlineGroupFocus = {
    ...
    dark: 'group-focus:outline-frame-600/40 dark:group-focus:outline-frame-950/80',
...
export const ghostOutlineGroupFocusWithin = {
    ...
    dark: 'group-focus-within:outline-frame-600/40 dark:group-focus-within:outline-frame-950/80',
...
export const ghostOutlinePeerFocus = {
    ...
    dark: 'peer-focus:outline-frame-600/40 dark:peer-focus:outline-frame-950/80',
...
export const outlinedBorder = {
    ...
    dark: 'border-frame-600 dark:border-frame-950',
...
export const outlinedOutline = {
    ...
    dark: 'outline-frame-600 dark:outline-frame-950',
